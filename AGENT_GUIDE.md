...
This project is a static company profile page prototype. It is designed to run on GitHub Pages or any static file server. There is no build step and no backend service in this repository.
